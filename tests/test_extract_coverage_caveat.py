...
113\t10\t548\t0.25
120\t7\t548\t0.25"""),
                   create=True) as test_input_file:
        self.assertEquals(extract_qc_call(test_input_file, 0.95, 100, 0.95, 50), "OK")
...
120\t7\t548\t0.25"""),
                   create=True) as test_input_file:
            self.assertEquals(extract_qc_call(test_input_file, 0.95, 100, 0.95, 50), "WARN")
...
120\t7\t548\t0.25"""),
                   create=True) as test_input_file:
            self.assertEquals(extract_qc_call(test_input_file, 0.95, 100, 0.95, 50), "FAIL")
